...
pde['visscalars'] = ["density", 0, "energy", 3, "langrange multiplier", 6]; # list of scalar fields for visualization
pde['visvectors'] = ["momentum", [1, 2], "magnetic", [4, 5]]; # list of vector fields for visualization
