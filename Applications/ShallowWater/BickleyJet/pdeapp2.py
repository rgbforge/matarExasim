...
pde['dt'] = 0.002*numpy.ones(5000);   # time step sizes
...
pde['visscalars'] = ["uy", 3, "vx", 4]; # list of scalar fields for visualization
pde['visvectors'] = ["momentum", [0, 1]]; # list of vector fields for visualization
