...
ax[0, 0].set_ylabel(r"Reference factor Thermal conductivity $\kappa_{0}$")

ax[0, 1].scatter(sample[:, 0], sample[:, 2], s=2)
ax[0, 1].set_xlabel(r"EUV efficiency $\epsilon$")
ax[0, 1].set_ylabel(r"Reference factor Dynamic Viscosity $\mu_{0}$")
...
ax[0, 2].set_ylabel(r"Reference factor Neutral Density $\rho_{0}$")

ax[1, 0].scatter(sample[:, 1], sample[:, 2], s=2)
ax[1, 0].set_xlabel(r"Reference factor Thermal conductivity $\kappa_{0}$")
ax[1, 0].set_ylabel(r"Reference factor Dynamic Viscosity $\mu_{0}$")
ax[1, 0].ticklabel_format(axis='both', style='sci', scilimits=(0,0))

ax[1, 1].scatter(sample[:, 1], sample[:, 3], s=2)
ax[1, 1].set_xlabel(r"Reference factor Thermal conductivity $\kappa_{0}$")
ax[1, 1].set_ylabel(r"Reference factor Neutral Density $\rho_{0}$")

ax[1, 2].scatter(sample[:, 2], sample[:, 3], s=2)
ax[1, 2].set_xlabel(r"Reference factor Dynamic Viscosity $\mu_{0}$")
ax[1, 2].set_ylabel(r"Reference factor Neutral Density $\rho_{0}$")
